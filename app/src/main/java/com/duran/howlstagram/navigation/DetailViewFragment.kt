...
import com.duran.howlstagram.databinding.FragmentDatailBinding
...
class DetailViewFragment: Fragment() {
    ...
    inner class DetailViewRecyclerViewAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        init {
            ...
            firestore?.collection("images")?.orderBy("itmestamp").addSnapshotListener { querySnaphsot, firebaseFirestoreException ->
                // 받자마자 값 초기화
                contentDTOs.clear()
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            var viewholder = (holder as CustomViewHolder).itemView // CustomViewHolder로 캐스팅
